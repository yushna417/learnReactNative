...
import {
    ...
    Platform, ScrollView, FlatList, ActivityIndicator,
} from "react-native";
...
import { BusinessFilterModal, SORT_OPTIONS } from "@/components/BusinessFilterModal";
            ...
            >
                ...
                <View className="px-6 pb-1">
                    ...
                    <View className="flex-row gap-2 mb-3">
                        ...
                        <TouchableOpacity
                            onPress={openFilters}
                            className={`w-12 h-12 rounded-xl items-center justify-center ${activeFilterCount > 0 ? "bg-yellow-500" : "bg-gray-100"
                                }`}
                        >
                            <Ionicons name="options-outline" size={22} color={
                                activeFilterCount > 0 ? "#fff" : "#374151"
                            } />
                            {activeFilterCount > 0 && (
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        ...
                        {state.category !== "All" && (
                            ...
                            >
                                <Text className="text-yellow-800 text-sm">{state.category}</Text>
                ...
                {isLoading ? (
                    <View className="flex-1 justify-center items-center">
                        ...
                        <Text className="text-gray-400 mt-3 text-sm">Fetching businesses…</Text>
                    </View>
