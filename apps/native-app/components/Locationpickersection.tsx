                ...
                <View className="bg-green-50 border border-green-200 rounded-2xl p-4 mb-3">
                    <View className="flex-row items-start gap-3">
                        ...
                        <View className="flex-1">
                            <Text className="text-green-800 font-semibold text-sm" numberOfLines={1}>
            ...
            {(!hasLocation || showAddressInput) && (
                <View className="gap-3">
                    ...
                    <TouchableOpacity
                        ...
                        className={`flex-row items-center gap-3 p-4 rounded-2xl border-2 ${state.locationLoading
                    ...
                    {state.locationDenied && (
                        <View className="bg-red-50 border border-red-200 rounded-xl p-3 flex-row items-start gap-2">
                            ...
                            <Text className="text-red-600 text-xs flex-1">
                                Location permission denied. Enable it in Settings, or search a place
                                manually above.
                            </Text>
                        </View>
                    )}
